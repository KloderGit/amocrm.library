...
namespace Crm.Tests.Mappings
{
    ...
    public class CompanyDtoToCompanyTest
    {
        ...
        public CompanyDtoToCompanyTest()
        {
            ...
            companyDto = CompanyMockData.GetCompanyDTO().First();
        }
        ...
        public void MapEmptyCompanyDtoToCompany()
        {
            ...
            var companyFromDto = new CompanyDTO().Adapt<Company>();
        ...
        [TestMethod] public void NameIsEmpty() => Assert.AreEqual(new CompanyDTO().Adapt<Company>().Name, string.Empty);
        ...
        [TestMethod] public void TagsIsNull() => Assert.IsNotNull(new CompanyDTO().Adapt<Company>().Tags);
        ...
        [TestMethod] public void FieldsIsNull() => Assert.IsNotNull(new CompanyDTO().Adapt<Company>().Fields);
        ...
        [TestMethod] public void LeadsIsNull() => Assert.IsNotNull(new CompanyDTO().Adapt<Company>().Fields);
        ...
        [TestMethod] public void ContactsIsNull() => Assert.IsNotNull(new CompanyDTO().Adapt<Company>().Contacts);
        ...
        [TestMethod] public void CustomersIsNull() => Assert.IsNotNull(new CompanyDTO().Adapt<Company>().Customers);
    }
}
