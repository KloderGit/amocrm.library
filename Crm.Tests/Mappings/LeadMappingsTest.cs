...
namespace Crm.Tests.Mappings
{
    ...
    public class LeadDtoToLeadTest
    {
        ...
        [TestMethod] public void NameIsEmpty() => Assert.AreEqual(new LeadDTO().Adapt<Lead>().Name, string.Empty);
        [TestMethod] public void NameIsNotNull() => Assert.IsNotNull(new LeadDTO().Adapt<Lead>().Name);

        [TestMethod] public void CreatedAt() => Assert.AreEqual(dto.Adapt<Lead>().CreatedAt, new DateTime().FromTimestamp(1527690442));
        [TestMethod] public void CreatedAtZero() => Assert.AreEqual(new LeadDTO().Adapt<Lead>().CreatedAt, DateTime.MinValue);

        [TestMethod] public void UpdatedAt() => Assert.AreEqual(dto.Adapt<Lead>().UpdatedAt, new DateTime().FromTimestamp(1567519347));
        [TestMethod] public void UpdatedAtZero() => Assert.AreEqual(new LeadDTO().Adapt<Lead>().UpdatedAt, DateTime.MinValue);

        [TestMethod] public void ClosestTaskAt() => Assert.AreEqual(dto.Adapt<Lead>().ClosestTaskAt, new DateTime().FromTimestamp(1567630740));
        [TestMethod] public void ClosestTaskAtZero() => Assert.AreEqual(new LeadDTO().Adapt<Lead>().ClosestTaskAt, DateTime.MinValue);

        [TestMethod] public void ClosedAt() => Assert.AreEqual(dto.Adapt<Lead>().ClosedAt, new DateTime().FromTimestamp(1567514942));
        [TestMethod] public void ClosedAtZero() => Assert.AreEqual(new LeadDTO().Adapt<Lead>().ClosedAt, DateTime.MinValue);

        [TestMethod] public void IsDeleted() => Assert.AreEqual(dto.Adapt<Lead>().IsDeleted, false);
        [TestMethod] public void IsDeletedNull() => Assert.IsNull(new LeadDTO().Adapt<Lead>().IsDeleted);
        ...
        [TestMethod] public void MainContactIsNull() => Assert.AreEqual(new LeadDTO().Adapt<Lead>().MainContact, 0);
        ...
        [TestMethod] public void CompanyIsNull() => Assert.IsNull(new LeadDTO().Adapt<Lead>().Company);
        ...
        [TestMethod] public void PipelineIsNull() => Assert.AreEqual(new LeadDTO().Adapt<Lead>().Pipeline, 0);
        ...
        [TestMethod] public void TagsIsNull() => Assert.IsNotNull(new LeadDTO().Adapt<Lead>().Tags);
        ...
        [TestMethod] public void FieldsIsNull() => Assert.IsNotNull(new LeadDTO().Adapt<Lead>().Fields);
        ...
        [TestMethod] public void ContactsIsNull() => Assert.IsNotNull(new LeadDTO().Adapt<Lead>().Contacts);
